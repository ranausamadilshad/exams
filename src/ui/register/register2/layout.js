        ...
        <section className="py-0">
            <div className="container">
                <div className="flex-center min-vh-100 py-6 row">
                    <div className="col-xxl-5 col-sm-10 col-lg-7"><a className="text-decoration-none" href="/">
                            <div className="d-flex flex-center font-weight-extra-bold fs-5 mb-4"><img className="mr-2"
                                    src={logo} alt="Logo" width="58"/><span className="text-sans-serif">falcon</span>
                            </div>
                        </a>
                            ...
                            <div className="bg-light card-header">
                                <ul className="justify-content-center nav">
                                    <li className="nav-item"><a
                                            className="font-weight-semi-bold done cursor-pointer nav-link"><span
                                                className="nav-item-circle-parent"><span className="nav-item-circle"><svg
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="lock" className="svg-inline--fa fa-lock fa-w-14 "
                                                ...
                                                className="d-none d-md-block mt-1 fs--1">Account</span></a></li>
                                    <li className="nav-item"><a
                                            className="font-weight-semi-bold done  cursor-pointer nav-link"><span
                                                className="nav-item-circle-parent"><span className="nav-item-circle"><svg
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="user" className="svg-inline--fa fa-user fa-w-14 "
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 448 512">
                                                        <path fill="currentColor"
                                                ...
                                                className="d-none d-md-block mt-1 fs--1">Personal</span></a></li>
                                    ...
                                    <li className="nav-item"><a
                                            className="font-weight-semi-bold done  cursor-pointer nav-link"><span
                                                ...
                                                className="d-none d-md-block mt-1 fs--1">Done</span></a></li>
                                </ul>
                            </div>
                            <div className="fs--1 font-weight-normal px-md-6 pt-4 pb-3 card-body">
                                <div className="row">
                                    <div className="text-center col">
                                        <div className="wizard-lottie-wrapper">
                                            <div className="wizard-lottie mx-auto">
                                                <div title="" role="button" aria-label="animation" tabindex="0"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 264 464"
                                                        width="264" height="464" preserveAspectRatio="xMidYMid slice"
                                                        ...
                                                        <g clip-path="url(#__lottie_element_2)">
                                                            <g transform="matrix(1,0,0,1,132,232)" opacity="1"
                                                                ...
                                                                <g opacity="1"
                                                                    ...
                                                                    <g opacity="1" transform="matrix(1,0,0,1,-9,8)">
                                                                        <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                                            <g opacity="1"
                                                                                transform="matrix(1,0,0,1,0,0)">
                                                                                <path fill="rgb(203,240,248)"
                                                                ...
                                                                <g opacity="1" transform="matrix(1,0,0,1,0,147)">
                                                                    ...
                                                                    <g opacity="0" transform="matrix(1,0,0,1,24,-28)">
                                        ...
                                        <p className="fs-0">Now you can access to your account</p><button type="button"
                                            className="px-5 my-3 text-white btn btn-primary">Start Over</button>
                                    </div>
                                </div>
                            </div>
                            <div className="px-md-6 bg-light d-none card-footer"><button type="button"
                                    className="px-0 font-weight-semi-bold btn btn-link"><svg aria-hidden="true"
                                        focusable="false" data-prefix="fas" data-icon="chevron-left"
                                        className="svg-inline--fa fa-chevron-left fa-w-10 mr-1" role="img"
                                    ...
                                    </svg>Prev</button><button type="submit"
                                    className="ml-auto px-5 btn btn-primary">Next<svg aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="chevron-right"
                                        className="svg-inline--fa fa-chevron-right fa-w-10 ml-1" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                                        style={{transformOrigin:" 0.3125em 0.5625em"}}>
                                        <g transform="translate(160 256)">
                                            <g transform="translate(0, 32)  scale(0.75, 0.75)  rotate(0 0 0)">
